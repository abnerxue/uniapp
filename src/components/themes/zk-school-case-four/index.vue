  ...
  <view class="zk-school-case-four">
    <view class="school_case_four_container" v-if="widgetModel">
      ...
      <view class="case_card_text" v-if="widgetModel[3].switch">
        ...
        <view class="case_card_text_info" v-html="widgetModel[3].detail">商家简介 --- 常孝天下人工智能机器人是一个完善的营销系统，我们不仅仅提供营销工具与策略，背后更是有一个强大的“产品供应链+仓储物流+互联网技术”作为支撑。为您降低风险、解决后顾之忧。</view>
      </view>
