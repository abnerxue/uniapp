...
<script>
  ...
  export default {
    ...
    onShow () {
      ...
      //     title: '常孝天下人工智能机器人',
      //     summary: '常孝天下人工智能机器人商家盈利系统火热报名中，5月23日广东东莞常平',
    ...
    methods: {
      async init () {
        ...
        if (this.$api.client() === 'WapH5' || this.$api.client() === 'WeChat') {
          this.$api.share('常孝天下人工智能机器人', 'https://s-open.qiniuniu99.com/wwwroot/Uploads/Core/2019/05/5cdea75089bdb517785b6ffb.png', detail)
        }
